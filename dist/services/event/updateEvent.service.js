...
const updateEventService = ({ name, description, date, id, user }) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (id.length !== 36) {
      throw new app_error_1.default("Wrong event id", 404);
    }
    const eventRepository = data_source_1.AppDataSource.getRepository(
      Event_1.Event
    );
    ...
    if (
      (event === null || event === void 0 ? void 0 : event.user.id) !== user
    ) {
...
exports.default = updateEventService;
