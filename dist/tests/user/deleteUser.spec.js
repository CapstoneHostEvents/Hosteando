...
(0, globals_1.describe)("Test for DELETE method at /users/:id", () => {
    ...
    (0, globals_1.test)("Trying to delete a user", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0, globals_1.test)("Trying to delete a user that doesn't exist", () => __awaiter(void 0, void 0, void 0, function* () {
