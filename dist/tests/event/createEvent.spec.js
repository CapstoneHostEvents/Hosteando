...
(0, globals_1.describe)("Create a Event", () => {
    ...
    (0, globals_1.beforeAll)(() => __awaiter(void 0, void 0, void 0, function* () {
        yield data_source_1.AppDataSource.initialize().then((res) => (connection = res)).catch((err) => {
    ...
    (0, globals_1.it)("Trying to create an event with correct body with no token", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default).post("/event").send(eventCorrect);
